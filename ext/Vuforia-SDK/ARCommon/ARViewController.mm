...
//        [textures release];// TODO ARCfix
    ...
    if (arView != nil)
    {
// TODO ARCfix        [arView release];
        arView = nil;
    }
    
    if (parentView != nil)
    {
// TODO ARCfix        [parentView release];
        parentView = nil;
    }
}
...
// TODO ARCfix    textures = [[NSMutableArray array] retain];
	textures = [NSMutableArray array];
    
    @try {
        for (int i = 0; i < nTextures; ++i) {
// TODO ARCfix            Texture* tex = [[[Texture alloc] init] autorelease];
